...
oracle_code = '''# aibe/agents/executive/oracle.py
...
minerva_code = '''# aibe/agents/executive/minerva.py
...
with open("c:/Users/ADRIANO/AIDA/aibe/agents/executive/oracle.py", "w", encoding="utf-8") as f:
    f.write(oracle_code)
    
with open("c:/Users/ADRIANO/AIDA/aibe/agents/executive/minerva.py", "w", encoding="utf-8") as f:
    f.write(minerva_code)

print("Executive agents updated successfully.")
